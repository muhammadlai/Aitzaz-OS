"""Tool schemas for the Aitzaz HUD display plugin.
...
HUD_DISPLAY = {
    ...
    "description": (
        ...
        "holographic panel on their Aitzaz HUD. ALWAYS use this when the user "
...
HUD_DISMISS = {
    "name": "hud_dismiss",
    "description": "Dismiss all holographic media panels from the user's Aitzaz HUD screen. Use when they say to close, clear, or dismiss what's on screen.",
