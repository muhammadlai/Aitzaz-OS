@echo off
rem Aitzaz AI Pro GPU STT worker (Windows). Copy to run-stt.bat, fill in the token.
rem Auto-start at logon: create AitzazSTT.vbs in shell:startup containing:
