  ...
  <div>
    <div class="mb-6">
      ...
      <p class="text-base-content/70">
        Select how you want to power Aitzaz's intelligence. You can always change
        this later.
      </p>
    </div>
    ...
    <div v-else-if="formData.aiProvider === 'zai'" class="space-y-4">
      <div class="alert alert-info text-sm">
        ...
        <span
          ...
          can still run through Aitzaz tools if configured.</span
        >
      </div>
    ...
    <div v-else-if="formData.aiProvider === 'minimax'" class="space-y-4">
      <div class="alert alert-info text-sm">
        ...
        <span
          ...
          Web search can still run through Aitzaz tools if configured.</span
        >
      </div>
    ...
    <div v-else-if="formData.aiProvider === 'deepseek'" class="space-y-4">
      <div class="alert alert-info text-sm">
        ...
        <span>
          DeepSeek uses an OpenAI-compatible chat completions endpoint. Aitzaz
    ...
    <div v-else-if="formData.aiProvider === 'codex'" class="space-y-4">
      ...
      <div class="rounded-lg border border-base-300 p-4 bg-base-200/40">
        ...
        <p class="text-sm text-base-content/70 mt-1">
          Aitzaz opens the official ChatGPT login in your browser. Tokens stay in
