...
export const useSettingsStore = defineStore('settings', () => {
  ...
  async function saveAndTestSettings() {
    ...
    if (openAIServiceTestSuccess) {
      ...
      generalStore.statusMessage = 'Re-initializing Aitzaz with new settings...'
